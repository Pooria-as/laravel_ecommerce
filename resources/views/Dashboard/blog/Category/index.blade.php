...
@section("content")
@section("Location","Blog")
@section("page","BlogCategory")
<style>
    .dis{
        display: flex;
    }
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Category FA</th>
            ...
            @endphp
              @foreach ($blogCategories as $category)
                  ...
                  <tr>
                    ...
                    <td>
                        {{ $category->category_name_FA}}
                    </td>
                    <td class="dis">
                        <a href="{{ route("BlogCategory.edit",$category->id) }}" class="btn btn-sm btn-primary">Edit</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">New BlogCategory</h5>
      ...
      <div class="modal-body">
          <form method="POST" action="{{ route("BlogCategory.store") }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="category_name_FA">
